...
public class WebConnectHelper {
    ...
    /**
     * Returns the resulting object containing routing data from Google Maps
     * @param origin : 		The source location
     * @param destination : The destination location
     * @param type : 		The type of travel
     * @return : 			A JSONObject representation of the result.
     */
    public JSONObject getRouteResponse(String origin, String destination, String type){
        ...
        try{
            ...
            Log.e("AHHHH", "Something went wrong");
            e.printStackTrace();
            return null;
        }
    }
	...
	private String sendGet(String url, boolean verbose){
		...
		try{
			...
			Log.e("GET", "cannot send get data:" + e.getMessage());
		}
